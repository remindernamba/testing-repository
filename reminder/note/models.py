...
class Reminder(models.Model):
    user = models.ManyToManyField(Profile, verbose_name=_('Профиль'), default=None, null=True, blank=True, related_name='reminder')
    ...
    date_of_start = models.DateTimeField(verbose_name=_('Дата начало'), default=timezone.now(), null=True, blank=True)
    group = models.ForeignKey(Group, verbose_name=_('Группа'))
